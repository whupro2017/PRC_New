...
public class BurnDiffQueryController {
    ...
    public void UpdateElement(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        bdqp.setElement_id(Integer.parseInt(element_id));
        bdqp.setManager(manager);
        bdqp.setRemark(remark);
        bdqp.setElement_image(temp);
        bdqp.setBegin_date(create_date);
        bdqp.setLocalname(localname);
        BurnDiffqueryService.UpdateElement(bdqp);
    }
    ...
    public Object selectAllElement(String begin_date, String end_date, String key_word) {
        ...
        BurnDiffQueryParam bdqp = new BurnDiffQueryParam();
        bdqp.setKey_word(key_word);
        bdqp.setBegin_date(begin_date);
        bdqp.setEnd_date(end_date);
        ArrayList<BurnDiffQueryResult> list = BurnDiffqueryService.selectAllElement(bdqp);
    ...
    public void GetElementInfo(HttpServletRequest request, HttpServletResponse response) throws IOException { //根据要素id查询要素表获得要素信息返回前台显示
        ...
        bdqp.setElement_id(element_id);
        ArrayList<BurnDiffQueryResult> list = BurnDiffqueryService.GetElementInfo(bdqp);
    ...
    public void DeleteElement(String element_id, String type_id) throws Exception {
        ...
        BurnDiffqueryService.DeleteElement(bdqp);
