...
public class ExpDynQueryController {
    ...
    public void UpdateElement(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        edqp.setElement_id(Integer.parseInt(element_id));
        edqp.setManager(manager);
        edqp.setRemark(remark);
        edqp.setElement_image(temp);
        edqp.setBegin_date(create_date);
        edqp.setLocalname(localname);
        ExpDynqueryService.UpdateElement(edqp);
    }
    ...
    public Object selectAllElement(String begin_date, String end_date, String key_word) {
        ...
        ExpDynQueryParam edqp = new ExpDynQueryParam();
        edqp.setKey_word(key_word);
        edqp.setBegin_date(begin_date);
        edqp.setEnd_date(end_date);
        ArrayList<ExpDynQueryResult> list = ExpDynqueryService.selectAllElement(edqp);
    ...
    public void GetElementInfo(HttpServletRequest request, HttpServletResponse response) throws IOException { //根据要素id查询要素表获得要素信息返回前台显示
        ...
        edqp.setElement_id(element_id);
        ArrayList<ExpDynQueryResult> list = ExpDynqueryService.GetElementInfo(edqp);
    ...
    public void DeleteElement(String element_id, String type_id) throws Exception {
        ...
        ExpDynqueryService.DeleteElement(edqp);
