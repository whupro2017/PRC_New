...
public class BurnFuelQueryController {
    ...
    public void UpdateElement(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        bfqp.setElement_id(Integer.parseInt(element_id));
        bfqp.setManager(manager);
        bfqp.setRemark(remark);
        bfqp.setElement_image(temp);
        bfqp.setBegin_date(create_date);
        bfqp.setLocalname(localname);
        BurnFuelqueryService.UpdateElement(bfqp);
    }
    ...
    public Object selectAllElement(String begin_date, String end_date, String key_word) {
        ...
        BurnFuelQueryParam bfqp = new BurnFuelQueryParam();
        bfqp.setKey_word(key_word);
        bfqp.setBegin_date(begin_date);
        bfqp.setEnd_date(end_date);
        ArrayList<BurnFuelQueryResult> list = BurnFuelqueryService.selectAllElement(bfqp);
    ...
    public void GetElementInfo(HttpServletRequest request, HttpServletResponse response) throws IOException { //根据要素id查询要素表获得要素信息返回前台显示
        ...
        bfqp.setElement_id(element_id);
        ArrayList<BurnFuelQueryResult> list = BurnFuelqueryService.GetElementInfo(bfqp);
    ...
    public void DeleteElement(String element_id, String type_id) throws Exception {
        ...
        BurnFuelqueryService.DeleteElement(bfqp);
