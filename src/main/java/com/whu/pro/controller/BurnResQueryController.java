...
public class BurnResQueryController {
    ...
    public void UpdateElement(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        brqp.setElement_id(Integer.parseInt(element_id));
        brqp.setManager(manager);
        brqp.setRemark(remark);
        brqp.setElement_image(temp);
        brqp.setBegin_date(create_date);
        brqp.setLocalname(localname);
        BurnResqueryService.UpdateElement(brqp);
    }
    ...
    public Object selectAllElement(String begin_date, String end_date, String key_word) {
        ...
        BurnResQueryParam brqp = new BurnResQueryParam();
        brqp.setKey_word(key_word);
        brqp.setBegin_date(begin_date);
        brqp.setEnd_date(end_date);
        ArrayList<BurnResQueryResult> list = BurnResqueryService.selectAllElement(brqp);
    ...
    public void GetElementInfo(HttpServletRequest request, HttpServletResponse response) throws IOException { //根据要素id查询要素表获得要素信息返回前台显示
        ...
        brqp.setElement_id(element_id);
        ArrayList<BurnResQueryResult> list = BurnResqueryService.GetElementInfo(brqp);
    ...
    public void DeleteElement(String element_id, String type_id) throws Exception {
        ...
        BurnResqueryService.DeleteElement(brqp);
