...
public class KillEnvQueryController {
    ...
    public void UpdateElement(HttpServletRequest request, HttpServletResponse response) throws Exception {
        KillEnvQueryParam keqp = new KillEnvQueryParam();
        ...
        keqp.setElement_id(Integer.parseInt(element_id));
        keqp.setManager(manager);
        keqp.setRemark(remark);
        keqp.setElement_image(temp);
        keqp.setBegin_date(create_date);
        keqp.setLocalname(localname);
        KillEnvqueryService.UpdateElement(keqp);
    }
    ...
    public Object selectAllElement(String begin_date, String end_date, String key_word) {
        ...
        KillEnvQueryParam keqp = new KillEnvQueryParam();
        keqp.setKey_word(key_word);
        keqp.setBegin_date(begin_date);
        keqp.setEnd_date(end_date);
        ArrayList<KillEnvQueryResult> list = KillEnvqueryService.selectAllElement(keqp);
    ...
    public void GetElementInfo(HttpServletRequest request, HttpServletResponse response) throws IOException { //根据要素id查询要素表获得要素信息返回前台显示
        ...
        keqp.setElement_id(element_id);
        ArrayList<KillEnvQueryResult> list = KillEnvqueryService.GetElementInfo(keqp);
    ...
    public void DeleteElement(String element_id, String type_id) throws Exception {
        ...
        KillEnvqueryService.DeleteElement(keqp);
