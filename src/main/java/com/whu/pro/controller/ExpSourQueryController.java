...
public class ExpSourQueryController {
    ...
    public void UpdateElement(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        esqp.setElement_id(Integer.parseInt(element_id));
        esqp.setManager(manager);
        esqp.setRemark(remark);
        esqp.setElement_image(temp);
        esqp.setBegin_date(create_date);
        esqp.setLocalname(localname);
        ExpSourqueryService.UpdateElement(esqp);
    }
    ...
    public Object selectAllElement(String begin_date, String end_date, String key_word) {
        ...
        ExpSourQueryParam esqp = new ExpSourQueryParam();
        esqp.setKey_word(key_word);
        esqp.setBegin_date(begin_date);
        esqp.setEnd_date(end_date);
        ArrayList<ExpSourQueryResult> list = ExpSourqueryService.selectAllElement(esqp);
    ...
    public void GetElementInfo(HttpServletRequest request, HttpServletResponse response) throws IOException { //根据要素id查询要素表获得要素信息返回前台显示
        ...
        esqp.setElement_id(element_id);
        ArrayList<ExpSourQueryResult> list = ExpSourqueryService.GetElementInfo(esqp);
    ...
    public void DeleteElement(String element_id, String type_id) throws Exception {
        ...
        ExpSourqueryService.DeleteElement(esqp);
