...
public class CollObjQueryController {
    ...
    public void UpdateElement(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        coqp.setElement_id(Integer.parseInt(element_id));
        coqp.setManager(manager);
        coqp.setRemark(remark);
        coqp.setElement_image(temp);
        coqp.setBegin_date(create_date);
        coqp.setLocalname(localname);
        CollObjqueryService.UpdateElement(coqp);
    }
    ...
    public Object selectAllElement(String begin_date, String end_date, String key_word) {
        ...
        CollObjQueryParam coqp = new CollObjQueryParam();
        coqp.setKey_word(key_word);
        coqp.setBegin_date(begin_date);
        coqp.setEnd_date(end_date);
        ArrayList<CollObjQueryResult> list = CollObjqueryService.selectAllElement(coqp);
    ...
    public void GetElementInfo(HttpServletRequest request, HttpServletResponse response) throws IOException { //根据要素id查询要素表获得要素信息返回前台显示
        ...
        coqp.setElement_id(element_id);
        ArrayList<CollObjQueryResult> list = CollObjqueryService.GetElementInfo(coqp);
    ...
    public void DeleteElement(String element_id, String type_id) throws Exception {
        ...
        CollObjqueryService.DeleteElement(coqp);
