...
public class KillWeaQueryController {
    ...
    public void UpdateElement(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        kwqp.setElement_id(Integer.parseInt(element_id));
        kwqp.setManager(manager);
        kwqp.setRemark(remark);
        kwqp.setElement_image(temp);
        kwqp.setBegin_date(create_date);
        kwqp.setLocalname(localname);
        KillWeaqueryService.UpdateElement(kwqp);
    }
    ...
    public Object selectAllElement(String begin_date, String end_date, String key_word) {
        ...
        KillWeaQueryParam kwqp = new KillWeaQueryParam();
        kwqp.setKey_word(key_word);
        kwqp.setBegin_date(begin_date);
        kwqp.setEnd_date(end_date);
        ArrayList<KillWeaQueryResult> list = KillWeaqueryService.selectAllElement(kwqp);
    ...
    public void GetElementInfo(HttpServletRequest request, HttpServletResponse response) throws IOException { //根据要素id查询要素表获得要素信息返回前台显示
        ...
        kwqp.setElement_id(element_id);
        ArrayList<KillWeaQueryResult> list = KillWeaqueryService.GetElementInfo(kwqp);
    ...
    public void DeleteElement(String element_id, String type_id) throws Exception {
        ...
        KillWeaqueryService.DeleteElement(kwqp);
