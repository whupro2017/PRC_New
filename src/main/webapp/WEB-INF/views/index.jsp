			...
			<div class="main-container-inner">
				...
				<div class="sidebar" id="sidebar">
					...
					<ul class="nav nav-list">
						...
						<li>
							<a href="workview/burn_index.jsp">
								<i class="icon-fire"></i>
						...
						<li>
							<a href="workview/colorpoints.jsp">
								<i class="icon-star"></i>
