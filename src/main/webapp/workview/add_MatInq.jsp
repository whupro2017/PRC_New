...
<script>
    function selectImage(file) {
        ...
        if(file.files[0].size<23485760 ){     //大于20M的图片不显示
        	...
        	image.src="http://localhost:8080/pro/images/imagetoobig.png";
        }
    }
</script>
...
<script type="text/javascript">
			...
			<table style="background-color:transparent;">	
				...
				<tr >
					...
					<td style="padding-left:5px;padding-top:10px">
						<input id="c_manager" style= "height:25px;width:185px;"></input>
					</td>					
				</tr>
				...
				<tr >
					...
					<td style="padding-left:5px;padding-top:10px">
						<textarea id="c_remark" rows="1" cols="20"></textarea>
					</td>					
				</tr>	
				...
				<tr >
					...
					<td style="padding-left:5px;padding-top:10px">
	                            <input type="file"  id="c_image"  class="file-btn" onchange="selectImage(this)"/>
					</td>	
				</tr> 
	...
	<div style="background-color: transparent; float:top;padding-top: 300px" align="center">
		<button id="add" style= "height:25px;width:65px" onClick="material_inquisition_luru()">录入</button>				
