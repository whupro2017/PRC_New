...
<html lang="en">
	...
	<body>
											...
											<table style="background-color:transparent;">				
												<tr>
													...
													<td class="tdTwo" rowspan="2" style= "padding-left:15px;">
														<button id="AddCase" style= "height:30px;width:60px ;background-color:#0099ff" onclick="diag()" >录入</button>														
													</td>						
												</tr>
												<tr >
		...
		function diag()
		{
			window.open ("addCase.jsp", "addCase", "height=300, width=410, top=100, left=100,toolbar=no, menubar=no, scrollbars=no, resizable=no, location=no, status=no");
		}	
		</script>				
</body>
</html>