		...
		<div class="main-container-inner">
			...
			<div class="sidebar" id="sidebar">
				...
				<ul class="nav nav-list">
					...
					<li class="active"><a href="element.jsp"> <i
					...
					<div style="width: 45%; float: left;">
						<div class="tab1"
							...
							<ul id="myTab" class="nav nav-tabs">
								...
								<li><a href="#trail" data-toggle="tab">案件关联</a></li>
								<li><a href="#trail" data-toggle="tab">要素关联</a></li>
								<li><a href="#trail" data-toggle="tab">时间关联</a></li>
								<li><a href="#trail" data-toggle="tab">场景关联</a></li>
								<li><a href="#trail" data-toggle="tab">位置关联</a></li>
							</ul>
