		...
		<div class="navbar-container" id="navbar-container">
			<div class="navbar-header pull-left">
				<a href="#" class="navbar-brand"> <img src="./logo.png" /> <text
						style="vertical-align:middle;">案事件现场勘验综合展示系统</text></a>
				<!-- /.brand -->
			</div>
			<!-- /.navbar-header -->
		</div>
										...
										<table style="background-color: transparent;">
											...
											<tr>
												...
												<td style="padding-left: 4px">
													        ...
													        <button id="BurnSourBotton" style="height: 25px; width: 65px">查询</button>
												</td>
											</tr>
										</table>
									   </div>
									   <div style="padding-top: 3px">
										<table id="table_burn_source"></table>
									</div>
								</div>
										...
										<table style="background-color: transparent;">
											...
											<tr>
												...
												<td style="padding-left: 4px">
															<input type="text" 	style="height: 25px; width: 105px;" id="begin_date" class="date" placeholder="开始时间">
														    <input type="text"    style="height: 25px; width: 105px;" id="end_date" class="date" placeholder="结束时间">
													        <button id="BurnFuelBotton" style="height: 25px; width: 65px">查询</button>
												</td>
											</tr>
										</table>
									   </div>
									   <div style="padding-top: 3px">
										<table id="table_burn_fuel"></table>
									</div>
								</div>
										...
										<table style="background-color: transparent;">
											...
											<tr>
												...
												<td style="padding-left: 4px">
															<input type="text" 	style="height: 25px; width: 105px;" id="begin_date" class="date" placeholder="开始时间">
														    <input type="text"    style="height: 25px; width: 105px;" id="end_date" class="date" placeholder="结束时间">
													        <button id="BurnSubBotton" style="height: 25px; width: 65px">查询</button>
												</td>
											</tr>
										</table>
									   </div>
									   <div style="padding-top: 3px">
										<table id="table_burn_subject"></table>
									</div>
								</div>
										...
										<table style="background-color: transparent;">
											...
											<tr>
												...
												<td style="padding-left: 4px">
															<input type="text" 	style="height: 25px; width: 105px;" id="begin_date" class="date" placeholder="开始时间">
														    <input type="text"    style="height: 25px; width: 105px;" id="end_date" class="date" placeholder="结束时间">
													        <button id="BurnDiffBotton" style="height: 25px; width: 65px">查询</button>
												</td>
											</tr>
										</table>
									   </div>
									   <div style="padding-top: 3px">
										<table id="table_burn_diffusion"></table>
									</div>
								</div>
										...
										<table style="background-color: transparent;">
											...
											<tr>
												...
												<td style="padding-left: 4px">
															<input type="text" 	style="height: 25px; width: 105px;" id="begin_date" class="date" placeholder="开始时间">
														    <input type="text"    style="height: 25px; width: 105px;" id="end_date" class="date" placeholder="结束时间">
													        <button id="BurnResBotton" style="height: 25px; width: 65px">查询</button>
												</td>
											</tr>
										</table>
									   </div>
									   <div style="padding-top: 3px">
										<table id="table_burn_result"></table>
									</div>
								</div>
